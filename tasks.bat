...
schtasks /create /tn "Terminal update nomenclature" /f /sc WEEKLY /d sun /st 03:01 /ru terminal /tr "%PHP_COMMAND% -c %PHP_INI% %WWW_PATH%\install\import_items.php"
schtasks /create /tn "Terminal update goods photos" /f /sc WEEKLY /d sun /st 05:01 /ru terminal /tr "%PHP_COMMAND% -c %PHP_INI% %WWW_PATH%\install\import_items_photos.php"
schtasks /create /tn "Terminal update goods descriptions" /f /sc WEEKLY /d sun /st 05:30 /ru terminal /tr "%PHP_COMMAND% -c %PHP_INI% %WWW_PATH%\install\import_desc.php"
