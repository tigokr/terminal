...
schtasks /create /tn "Terminal kill metrointerface" /f /sc ONLOGON /ru terminal /delay 0000:05 /tr "%TERM_PATH%lib\metrokiller.exe /s"
schtasks /create /tn "Terminal browser" /f /sc ONLOGON /ru terminal /delay 0000:05 /tr "%TERM_PATH%lib\WpfWbApp.exe"
